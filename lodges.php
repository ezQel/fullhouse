...
$sql = "select propertyname,location,price_rate,propertypic,owner FROM property where category='lodges'";
...
<td><span class="glyphicon glyphicon-usd"></span>'.$row["price_rate"].'/day</td>
