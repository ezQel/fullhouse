...
<div >
 <form  role="form" action="login_submit.php" method="POST" >
  <div class="form-group">
    ...
    <input type="phone" class="form-control" name= "phone" id="phone" pattern="[0-9]{10}" required autofocus>
  </div>
  <div class="form-group">
...
<p>* required</p>
 <form  role="form" action="signup.php " method="post">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <label for="phone">Phone *</label>
    <input type="text" class="form-control" placeholder="format: 0720621037" name="phones" pattern="[0-9]{10}" required>
  </div>
    <div class="form-group">
    <label for="pwd">Password *</label>
