...
<li><a href="houses.php">Apartments</a></li>
...
<li class="active"><a href="#">Edit <span class="glyphicon glyphicon-pencil pull-right"></span></a></li>
<li>
...
<div class="col-md-4 col-sm-6">
<br><br><br>
<form role="form" action="edit_proc2.php" method="POST" enctype="multipart/form-data">
<div class="form-group">
<label for="profilepic">Profilepic</label>
<input type="file" id="profilepic" name="fileToUpload" required>
...
<h4 ><span class=" 	glyphicon glyphicon-plus"></span> Add Property</h4>

<form role="form" action="prop_add.php" method="POST" enctype="multipart/form-data">
<div class="form-group">
<label for="propertypic">Propertypic</label>
...
<option value="camping sites">Camping Sites</option>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="price_rate" required>
  </div>
