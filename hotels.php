...
$sql = "select propertyname,location,price_rate,propertypic,owner FROM property where category='hotels'";
...
<td><span class="glyphicon glyphicon-usd"></span>'.$row["price_rate"].'/night</td>
