...
$sql = "select propertyname,location,price_rate,propertypic,owner FROM property where propertyname LIKE '{$value}'";
...
<div class="sory"><span class="glyphicon glyphicon-exclamation-sign"></span>
We are Sorry!<br></div> Your search term returned 0 results. Try a different search term
